...
def stock_checks():
    image = (OUT / 'content-inventory.gba').read_bytes()
    ...
    for item in registry['items']:
        ...
        for quantity in (1, 3):
            ...
            buy_cases += 1
    return {'compiledFunction': symbols['ffta_shop_buy_list'], 'engineSha1': hashlib.sha1(binary).hexdigest(),
