...
const documents=['JOB-CLASS-SPECIFICATION.md','SUPPORT-SKILL-DESIGN.md','AXE-SKILL-EXPANSION.md','JOB-THEME-AUDIT.md','JOB-DESIGN-PRINCIPLES.md','JOB-EXPANSION-DESIGN.md','START-HERE.md','STARTER-JOB-INSPIRATION.md','BALANCE-COUNCIL.md','SPELLBLADE-EXPANSION.md','ABILITY-EXPANSION-COUNCIL.md','WEAPON-ACQUISITION.md'];
