...
const help={
 'SAM-S1':'Act before moving to boost HP damage and healing by 25 percent. No items.',
 'GLD-AX-S1':'Move at least 2 tiles from turn start for 35 percent more physical damage.'
};
const last=first+Object.keys(help).length-1,builder=new ROMBuilder(image,{start:0x12d0000,end:0x12e0000});
...
const address=builder.allocate('Turn support help bank',table);builder.rom.writeUInt32LE(address,pointer);builder.rom.writeUInt16LE(last,ranges+84);
