...
$fftaRom = Join-Path $fftaRoot 'roms/play/expansion-v0.7/FFTA_Expansion_v0.7.gba'
$fftaSave = Join-Path $fftaRoot 'saves/expansion-v0.7'
$fftaEmulator = Join-Path $fftaRoot 'tools/mgba/mGBA-0.10.5-win64/mGBA.exe'
$fftaManifest = Join-Path $fftaRoot 'build/releases/v0.7/manifest.json'
...
$fftaExpected = '1b070824a8dad4995434eee3ab40fa08187a6120'
...
if ($fftaData.rom.sha1 -ne $fftaExpected -or $fftaDigest -ne $fftaExpected) {
    throw 'Expansion ROM differs from the verified v0.7 release.'
}
