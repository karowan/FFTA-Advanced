...
for initial in (-1,3):
 ...
 call('ffta_snapshot_end',child);check('child_is_cleared',m.read(child,820),bytes(820))
 ...
 call('ffta_snapshot_end',scope);check('root_retired',m.word(0x0203ff48),0);check('scope_is_cleared',m.read(scope,820),bytes(820))
