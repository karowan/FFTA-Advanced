"""Fresh native battle for this exact Chemist candidate, in ignored local output."""
...
meta=_load_job_candidate(ROOT/'build/expansion/probes/chemist/current.json');rom=pathlib.Path(meta['path'])
