"""Native existing help preservation and private Dark Knight action/support descriptions."""
...
P=ROOT/'build/expansion/probes';meta=_load_job_candidate(P/'dark-knight/current.json');ROM=pathlib.Path(meta['path']);rom=ROM.read_bytes()
