...
**Spellblade — Viera.** Every action requires a primary rapier/saber and is blocked by Silence. Select self preparation (Sure) or one r1 enemy for an immediate enchanted A-type strike. Pay once; apply/replace the enchantment even if the strike misses; this is one action, not a free second action or movement. The strike is physical and not Fight: no crit, weapon proc, second weapon, Doublecast, or automatic bypass of applicable defensive reactions.
...
| Mystic Knight | 1600 | 650 | 650 | 100 | 3000 |
