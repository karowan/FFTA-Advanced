...
September 14, 2026. **Candidate review, not adoption.** The approved current design remains version 0.6 with Mystic Knight's fourteen actions, 122 project abilities, and 78 teaching items. This council does not add any further action to the canonical tables or change the ROM.
...
- [Martial review](../expansion-council-martial.md): Samurai, both Dark Knights, Viking, and existing axe additions; official lineage, numbers, legal builds and rejected alternatives.
- [Utility review](../expansion-council-utility.md): Geomancer, both Chemists, Bard and Dancer; recipes, movement reconciliation, fields and legal secondary commands.
- [Adversarial review](../expansion-council-skeptic.md): independent priorities, cross-class interactions, and approved Spellblade integration checks.
...
Exact figures above are review targets, not tested balance or implemented features. No candidate creates another support slot, reaction slot, learned command, immediate turn, new race, growth advantage, prerequisite change, consumable shop stock, or higher weapon-power ceiling. Teaching/AP records are to be designed only for abilities that are subsequently adopted. Original 0.5 council evidence remains historical; this report's candidate counts never replace current 0.6 totals.
