...
The [approved vanilla+ foundation](VANILLA-PLUS-PACKAGE.md) also adds completion safeguards, rare-equipment recovery, clan sorting, Morpher visuals, and small menu improvements. These are selected additions to our own vanilla-based build, not adoption of an existing mod pack. The roster and progression below remain unchanged.
